...
/**
 * Creates a new conversation (and its main branch) for the current user.
 *
 * @param title - Optional title; defaults to "New Chat".
 * @returns The conversation, plus `mainBranchId` for the caller to route to.
 */
export async function createConversation(title = "New Chat") {
    ...
    return { ...conversation, mainBranchId: branch.id };
}
